package pe.edu.upc.center.platform.recipes.interfaces.rest;

import io.swagger.v3.oas.annotations.tags.Tag;
import org.springframework.http.HttpStatus;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.*;
import pe.edu.upc.center.platform.recipes.aplication.internal.commandservices.FavoriteRecipeCommandServiceImpl;
import pe.edu.upc.center.platform.recipes.aplication.internal.queryservices.FavoriteRecipeQueryServiceImpl;
import pe.edu.upc.center.platform.recipes.domain.model.commands.DeleteFavoriteRecipeCommand;
import pe.edu.upc.center.platform.recipes.domain.model.queries.GetAllFavoriteRecipesByUserIdQuery;
import pe.edu.upc.center.platform.recipes.domain.model.queries.GetFavoriteRecipeByUserIdAndRecipeIdQuery;
import pe.edu.upc.center.platform.recipes.interfaces.rest.resources.CreateFavoriteRecipeResource;
import pe.edu.upc.center.platform.recipes.interfaces.rest.resources.FavoriteRecipeResource;
import pe.edu.upc.center.platform.recipes.interfaces.rest.transform.CreateFavoriteRecipeCommandFromResourceAssembler;
import pe.edu.upc.center.platform.recipes.interfaces.rest.transform.FavoriteRecipeResourceFromEntityAssembler;
...
public class FavoriteRecipesController {
    ...
    public ResponseEntity<?> deleteFavoriteRecipe(@PathVariable Long userId, @PathVariable Long recipeId) {
